...
return this.gBb()===b.Bb&&this.G6===b.G6&&this.R===b.R&&this.fg===b.fg},
gtU:function(a){var z,y,x,w
z=this.gBb()&0x1FFFFFFF
y=this.G6&0x1FFFFFFF
x=this.R&0x1FFFFFFF
...
return}throw "Unable to print message: " + String(a)}}],["","file:///C:/Users/project%20ZOM/dart/Llarrie/web/llarrie.dart",,O,{
"":"",
...
x.sR(y,700)
x.sfg(y,400)
x=H.VM(new W.Cq(y,C.Wh.Ph,!1),[null])
H.VM(new W.xC(0,x.uv,x.Ph,W.VF(O.Km()),x.Sg),[H.Kp(x,0)]).Zz()
y=H.VM(new W.Cq(y,C.hV.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(O.yM()),y.Sg),[H.Kp(y,0)]).Zz()
document.body.appendChild($.qN)
$.Jj=W.jm(null,"img/llarrie.png",null)
$.GO=W.jm(null,"img/bg.png",null)
$.u9=W.jm(null,"img/bg2.png",null)
$.M6=W.jm(null,"img/frame.png",null)
$.UY=W.jm(null,"img/shop.png",null)
$.hL=W.jm(null,"img/bat.png",null)
$.VG=new O.mN(0,0,700,340)
$.Ho=new O.mG(10,278,0,0,!1,!1,$.GJ)
y=window
C.ol.hr(y)
C.ol.oB(y,W.VF(O.nT()))},"call$0","eE",0,0,0],
...
$.eI=z
if(y>10){$.vH=10
y=10}for(;y>=1;){if($.Ff){y=$.Ed
if(y>=116)$.NM=-1
else if(y<=0)$.NM=1}else $.NM=0
$.Ed=$.Ed+$.NM
if(C.jn.Y($.a0,20)===0){$.rU=$.pa().j1(680)
$.qA=$.pa().j1(380)}$.a0=$.a0+1
y=$.Fm()
x=$.VG
w=x.x
...
y.SE=w-1}else{w=-v
y.v3=w
y.v3=w*0.9}}}else y.v3=u+0.1
x=C.CD.yu(x)-$.YT
$.Wv=x
if(y.aK===0&&y.v3===0)if(y.oJ){w=$.Jn+C.jn.cU(x,20)
$.Jn=w
v=$.CZ()
u=$.dG
if(u>=3)return H.e(v,u)
if(w>=v[u]){$.dG=u+1
$.Jn=0}t=C.jn.cU(x,20)
$.UI=$.UI+C.CD.yu(t*1.1)
y.nv=!0
y.oJ=!1}if(!$.FU)if($.Ho.nv){$.FU=!0
$.hp=!0}y=$.vH-1
$.vH=y}y=$.Ee
y.clearRect(0,0,700,400)
y.fillStyle="#B6E6EA"
y.fillRect(0,0,700,400)
if(!$.Ho.nv){O.ze()
y=$.Ee
x=$.GO
w=$.Fm()
...
x=$.Ee
x.fillStyle="#000"
x.fillRect(0,340,700,60)
O.Wr("Made by FLS",284,384)
O.Wr("POW:",$.D7,$.cr+2)
J.I8($.Ee,$.Jj,H.VM(new P.tn($.D7+48,$.cr,120,16),[null]),H.VM(new P.tn(0,84,120,16),[null]))
J.I8($.Ee,$.Jj,H.VM(new P.tn($.D7+48+$.Ed,$.cr,4,16),[null]),H.VM(new P.tn(120,84,4,16),[null]))
if($.iJ)O.Wr("MAX POWER!!",$.D7,385)
O.Wr("Llarriez:"+C.jn.cU($.Wv,20),284,360)
y=$.Ho.SE
if(y>0)O.Wr("Bounces:"+y,700-("Bounces:"+$.Ho.SE+" ").length*12,385)
y=$.Ho
J.I8($.Ee,$.Jj,H.VM(new P.tn(C.CD.yu(y.x)-$.VG.x,C.CD.yu(y.y),22,20),[null]),H.VM(new P.tn(0,$.fT*20,22,20),[null]))}else{y=$.hp
x=$.Ee
if(y){y=$.M6
w=J.RE(y)
v=w.gR(y)
...
x.drawImage(y,s,r)
y=s+12
O.Wr("Distance:"+C.jn.cU($.Wv,20),y,r+13)
O.Wr("Money:"+$.UI,y,r+26)
x=r+96
O.Wr("Shop",s+13+132,x)
O.Wr("Continue?",y,x)
J.I8($.Ee,$.Jj,H.VM(new P.tn(223,r+150,44,38),[null]),H.VM(new P.tn(100,21,44,38),[null]))
O.Wr("Tweet your score",273,r+163)}else{x.fillStyle="#3D4449"
x.drawImage($.UY,0,0)
x.fillRect(0,320,700,80)
O.TP()
y=$.Ee
x=$.Jj
w=$.Jn
...
u=$.dG
if(u>=3)return H.e(v,u)
J.I8(y,x,H.VM(new P.tn(160,278,C.jn.yu(w/v[u]*384),12),[null]),H.VM(new P.tn(124,84,1,12),[null]))
O.Wr("Money:"+$.UI,50,$.cr-24)
O.Wr("Launch!",50,$.cr)
J.I8($.Ee,$.Jj,H.VM(new P.tn(134,$.cr,60,15),[null]),H.VM(new P.tn(0,101,60,15),[null]))}}y=window
C.ol.hr(y)
C.ol.oB(y,W.VF(O.nT()))}catch(q){H.Ru(q)
throw q}},"call$1","nT",2,0,8],
TP:function(){var z,y,x,w,v
for(z=0;z<3;++z){y=$.Ee
x=$.hL
w=new P.tn(160+z*172,107,40,40)
w.$builtinTypeInfo=[null]
v=new P.tn(0+z*40,0,40,40)
v.$builtinTypeInfo=[null]
J.I8(y,x,w,v)}for(z=0;z<3;++z){y=$.Ee
x=$.hL
w=new P.tn(160+z*172,200,40,40)
w.$builtinTypeInfo=[null]
v=new P.tn(0+z*40,40,40,40)
v.$builtinTypeInfo=[null]
J.I8(y,x,w,v)}},
...
x=$.Jj
w=$.VG
w=new P.tn(40*z-(C.jn.cU(C.jn.Y(w.x,700),5)+1),300-w.y,40,40)
w.$builtinTypeInfo=[null]
v=new P.tn(0,20,40,40)
v.$builtinTypeInfo=[null]
J.I8(y,x,w,v)}},
Wr:function(a,b,c){var z,y,x,w,v,u,t,s,r
a=a.toUpperCase()
for(z=a.length,y=0;y<z;++y){x=C.xB.u8("ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!?.,:;-=+/\\() ",a[y])
w=C.jn.Y(x,26)
v=C.jn.cU(x,26)
u=$.Ee
t=$.Jj
s=new P.tn(b+y*12,c,12,12)
s.$builtinTypeInfo=[null]
r=new P.tn(0+w*12,60+v*12,12,12)
...
z=$.FU
if(z&&!$.hp){O.wL(a,!0)
return}if(z){z=H.VM(new P.EX(a.layerX,a.layerY),[null])
y=H.VM(new P.EX(a.layerX,a.layerY),[null])
x=$.M6
w=J.RE(x)
v=w.gR(x)
if(typeof v!=="number")return v.Z()
...
x=O.pA(z.x,y.y,350-v+12,200+C.jn.cU(x,2)-24,108,12)
z=x}else z=!1
if(z)return
else{if($.FU){z=H.VM(new P.EX(a.layerX,a.layerY),[null])
y=H.VM(new P.EX(a.layerX,a.layerY),[null])
x=$.M6
w=J.RE(x)
v=w.gR(x)
...
x=w.gfg(x)
if(typeof x!=="number")return x.Z()
x=O.pA(z.x,y.y,350-v+13+132,200+C.jn.cU(x,2)-24,48,12)
z=x}else z=!1
if(z)return
else{if($.FU){z=H.VM(new P.EX(a.layerX,a.layerY),[null])
y=H.VM(new P.EX(a.layerX,a.layerY),[null])
x=J.OB($.M6)
if(typeof x!=="number")return x.Z()
x=O.pA(z.x,y.y,223,200-C.jn.cU(x,2)+150,192,38)
z=x}else z=!1
if(z)return
else if(!$.FU){$.Ff=!0
$.NM=1}}}},"call$1","Km",2,0,9],
...
if(z){$.FU=!1
O.b6()
return}else{if($.FU){z=H.VM(new P.EX(a.layerX,a.layerY),[null])
y=H.VM(new P.EX(a.layerX,a.layerY),[null])
x=$.M6
w=J.RE(x)
v=w.gR(x)
...
x=O.pA(z.x,y.y,223,200-C.jn.cU(x,2)+150,192,38)
z=x}else z=!1
if(z){z="https://twitter.com/intent/tweet?text="+("I shot Llarrie "+C.jn.cU($.Wv,20)+" Llarriez &hashtags=LlarrieLePhish")
a=document.createElement("a",null)
J.FQ(a,z)
J.TZ(a,"_black")
a.click()
return}else if(!$.FU){$.Ff=!1
z=$.Ho
if(z.oJ)return
z.aK=$.Ed/116*50*$.AD
z.v3=-(10-$.pa().w7()*3)
...
$.Ed=0
$.Ho.oJ=!0}}}},"call$1","yM",2,0,9],
wL:function(a,b){if(b);else if(O.pA(H.VM(new P.EX(a.layerX,a.layerY),[null]).x,H.VM(new P.EX(a.layerX,a.layerY),[null]).y,134,$.cr,60,15)){$.FU=!1
O.b6()}else if(O.pA(H.VM(new P.EX(a.layerX,a.layerY),[null]).x,H.VM(new P.EX(a.layerX,a.layerY),[null]).y,160,107,40,40)){if($.AD===2||$.UI<100)return
$.AD=2
$.UI=$.UI-100}else if(O.pA(H.VM(new P.EX(a.layerX,a.layerY),[null]).x,H.VM(new P.EX(a.layerX,a.layerY),[null]).y,160,200,40,40)){if($.GJ===2||$.UI<100)return
$.GJ=2
$.UI=$.UI-100}},
pA:function(a,b,c,d,e,f){var z
if(typeof a!=="number")return a.F()
if(a>=c){if(typeof b!=="number")return b.F()
z=b>=d&&a<=c+e&&b<=d+f}else z=!1
if(z)return!0
return!1},
mG:{
"":"a;x,y,aK,v3,oJ,nv,SE"},
mN:{
"":"a;x,y,ES,bK"}},1],])
...
I.$lazy($,"popLvls","ca","CZ",function(){return[5000,25000,100000]})
I.$lazy($,"bgX","VT","Fm",function(){return 0-($.VG.x+350)+10})
I.$lazy($,"bg2X","Ni","oH",function(){return 0-($.VG.x+350)+710})
I.$lazy($,"lastTime","eI","XW",function(){return P.Gi().y3})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"Xd",void:true,args:[J.VA]},{func:"bB",void:true,args:[W.Aj]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
oz.prototype=$desc
function D0(MU,vv,OX,OB,H9,lX,zN){this.MU=MU
this.vv=vv
this.OX=OX
this.OB=OB
this.H9=H9
...
if($desc instanceof Array)$desc=$desc[1]
Rd.prototype=$desc
function mG(x,y,aK,v3,oJ,nv,SE){this.x=x
this.y=y
this.aK=aK
this.v3=v3
this.oJ=oJ
this.nv=nv
this.SE=SE}mG.builtin$cls="mG"
if(!"name" in mG)mG.name="mG"
$desc=$collectedClasses.mG
if($desc instanceof Array)$desc=$desc[1]
mG.prototype=$desc
function mN(x,y,ES,bK){this.x=x
this.y=y
this.ES=ES
this.bK=bK}mN.builtin$cls="mN"
if(!"name" in mN)mN.name="mN"
$desc=$collectedClasses.mN
if($desc instanceof Array)$desc=$desc[1]
mN.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,QW,n6,Ny,Kh,TK,Y5,Gc,OM,QQ,fW,y4,d7,Um,DG,HA,bY,xO,Em,NW,rV,Wy,QF,hs,Wq,cm,Nh,cv,Fs,hY,ea,PZ,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,rE,Mi,HL,In,wP,eP,AL,Og,YI,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,P1,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,GX,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,WS,r0,nK,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,br,CC,PQ,uz,Yd,p8,AW,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,ZG,ox,ZD,vt,wD,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,HY,F0,FK,Pu,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,ZZ,AP,yH,FA,Av,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,a7,i1,xy,MH,SU,Ca,b8,vs,da,xw,dm,rH,mi,jb,wB,Gv,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,vp,Fj,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,D0,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,iP,Hn,Zl,pl,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,I2,RO,Cq,xC,mg,EX,IN,tn,ue,iY,Os,Rd,mG,mN]}