...
$.NF=new H.dC(v)
$.TX=new H.wN(u)
$.x7=new H.VX(t)},ud:function(a,b){return a(b)||b},Zr:{"":"a;bT,VC,Xs,Fa,Ga,cR",
...
if(z!=null&&z.Gv===0)z.OH(null)}},vp:{"":"a;",
Iv:function(a){this.ghG().Rg(a)},
SY:function(){this.ghG().Qj()}},Fj:{"":"a;",
Iv:function(a){this.ghG().w6(new P.LV(a,null))},
SY:function(){this.ghG().w6(C.Wj)}},q1:{"":"Zz;nL<,p4<,Z9<,QC<,iP,Gv,yx"},Zz:{"":"Kd+Fj;"},ly:{"":"MF;nL<,p4<,Z9<,QC<,iP,Gv,yx"},MF:{"":"Kd+vp;"},u8:{"":"ez;Y8",
...
$isiP:true,
static:{"":"Oj,Vp,df,p2,h2,QC,nm,Yp,kc,Xs,k3,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,zs,Fk",Gi:function(){var z=new P.iP(Date.now(),!1)
z.EK()
return z}}},Hn:{"":"Tp;",
...
"%":"CanvasRenderingContext2D"},OM:{"":"KV;B:length=","%":"CDATASection|CharacterData|Comment|ProcessingInstruction|Text"},Nh:{"":"Gv;",
bu:function(a){return a.toString()},
"%":"DOMException"},cv:{"":"KV;",
bu:function(a){return a.localName},
"%":";Element"},Fs:{"":"qE;fg:height%,LA:src},R:width%","%":"HTMLEmbedElement"},hY:{"":"ea;kc:error=","%":"ErrorEvent"},ea:{"":"Gv;",
...
"%":"MediaStream;EventTarget"},Yu:{"":"qE;B:length=","%":"HTMLFormElement"},tb:{"":"qE;fg:height%,LA:src},R:width%","%":"HTMLIFrameElement"},rE:{"":"qE;fg:height%,LA:src},R:width%","%":"HTMLImageElement"},Mi:{"":"qE;fg:height%,LA:src},R:width%","%":"HTMLInputElement"},El:{"":"qE;kc:error=,LA:src}","%":"HTMLAudioElement;HTMLMediaElement"},Aj:{"":"w6;pL:button=","%":"DragEvent|MSPointerEvent|MouseEvent|MouseScrollEvent|MouseWheelEvent|PointerEvent|WheelEvent"},KV:{"":"D0;",
bu:function(a){var z=a.nodeValue
return z==null?J.Gv.prototype.bu.call(this,a):z},
"%":"Attr|Document|DocumentFragment|DocumentType|Entity|HTMLDocument|Notation|SVGDocument|ShadowRoot;Node"},G7:{"":"qE;fg:height%,R:width%","%":"HTMLObjectElement"},j2:{"":"qE;LA:src}","%":"HTMLScriptElement"},lp:{"":"qE;B:length=","%":"HTMLSelectElement"},yN:{"":"qE;LA:src}","%":"HTMLSourceElement"},zD:{"":"ea;kc:error=","%":"SpeechRecognitionError"},RH:{"":"qE;LA:src}","%":"HTMLTrackElement"},w6:{"":"ea;","%":"CompositionEvent|FocusEvent|KeyboardEvent|SVGZoomEvent|TextEvent|TouchEvent;UIEvent"},aG:{"":"El;fg:height%,R:width%","%":"HTMLVideoElement"},Oi:{"":"D0;",
...
$isqC:true,
$isXj:true,
"%":";Uint8Array"},xG:{"":"AS+lD;",$isList:true,$aszM:null,$isqC:true},Vj:{"":"xG+SU;",$aszM:null}}],["","file:///C:/Users/project%20ZOM/dart/Llarrie/web/llarrie.dart",,O,{Iq:function(){O.X0()
var z=window
C.ol.hr(z)
C.ol.oB(z,W.VF(O.nT))},X0:function(){var z,y,x
$.qN=W.d9(null,null)
$.Ee=J.uP($.qN)
z=$.qN
y=J.RE(z)
y.sR(z,700)
y.sfg(z,400)
y=new W.eu(z,C.Wh.Ph,!1)
H.VM(y,[null])
x=new W.Ov(0,y.uv,y.Ph,W.VF(O.Km),y.Sg)
H.VM(x,[H.ip(y,"RO",0)])
x.Zz()
z=new W.eu(z,C.hV.Ph,!1)
H.VM(z,[null])
x=new W.Ov(0,z.uv,z.Ph,W.VF(O.yM),z.Sg)
H.VM(x,[H.ip(z,"RO",0)])
x.Zz()
document.body.appendChild($.qN)
O.po()
$.VG=new O.B9(0,0,700,340)
$.Ho=new O.mG(10,278,0,0,!1,!1)},po:function(){$.Jj=W.jm(null,"img/llarrie.png",null)
$.GO=W.jm(null,"img/bg.png",null)
$.zA=W.jm(null,"img/bg2.png",null)
$.M6=W.jm(null,"img/frame.png",null)},tV:function(a){var z,y,x
try{z=P.Gi().rq
...
y=window
C.ol.hr(y)
C.ol.oB(y,W.VF(O.nT))}catch(x){H.Ru(x)
throw x}},Hw:function(){var z,y
if($.mN){z=$.Ed
if(z>=116)$.NM=-1
else if(z<=0)$.NM=1}else $.NM=0
$.Ed=$.Ed+$.NM
if(C.jn.Y($.a0,20)===0){$.pa().toString
$.rU=Math.random()*680>>>0
$.pa().toString
$.qA=Math.random()*380>>>0}$.a0=$.a0+1
z=$.Fm()
y=$.VG.x
...
if(typeof z!=="number")throw z.E()
if(z<=-700+y)$.Ni=y+700
$.VG.x=C.CD.yu($.Ho.x)-350
$.Ho.Zf()},E2:function(){var z,y,x,w
z=$.Ee
z.save()
z.clearRect(0,0,700,400)
z.fillStyle="#B6E6EA"
z.fillRect(0,0,700,400)
if(!$.Ho.nv){O.ze()
z=$.Ee
y=$.GO
x=$.Fm()
...
O.Q4()
$.Ho.T1()}else O.uv()
$.Ee.restore()},uv:function(){var z,y,x,w,v
z=$.M6
y=J.RE(z)
x=y.gR(z)
...
$.Ee.drawImage(z,w,v)
z=w+12
O.Wr("Distance:"+C.jn.Z($.Wv,20),z,v+13)
O.Wr("Money:"+$.UI,z,v+26)},ze:function(){var z,y,x,w,v
for(z=0;z<=17;++z){y=$.Ee
x=$.Jj
w=new P.tn(40*z,300-$.VG.y,40,40)
w.$builtinTypeInfo=[null]
v=new P.tn(0,20,40,40)
v.$builtinTypeInfo=[null]
J.I8(y,x,w,v)}},Q4:function(){var z,y,x,w
z=$.Ee
z.fillStyle="#000"
z.fillRect(0,340,700,60)
O.yf("Made by FLS",384)
O.Wr("POW:",$.D7,$.cr+2)
z=$.Ee
y=$.Jj
x=new P.tn($.D7+48,$.cr,120,16)
H.VM(x,[null])
w=new P.tn(0,84,120,16)
H.VM(w,[null])
J.I8(z,y,x,w)
w=$.Ee
x=$.Jj
y=new P.tn($.D7+48+$.Ed,$.cr,4,16)
H.VM(y,[null])
z=new P.tn(120,84,4,16)
H.VM(z,[null])
J.I8(w,x,y,z)
if($.iJ)O.Wr("MAX POWER!!",$.D7,385)
O.Wr("Llarriez:"+C.jn.Z($.Wv,20),284,360)
O.Wr("Reset:",528,380)
z=$.Ee
y=$.Jj
x=new P.tn(600,378,60,15)
H.VM(x,[null])
w=new P.tn(0,100,60,15)
H.VM(w,[null])
J.I8(z,y,x,w)},Wr:function(a,b,c){var z,y,x,w,v,u,t,s,r
a=a.toUpperCase()
for(z=a.length,y=0;y<z;++y){x=C.xB.OY("ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!?.,:;-=+/\\() ",a[y])
w=C.CD.Y(x,26)
v=C.CD.Z(x,26)
u=$.Ee
t=$.Jj
...
J.I8(u,t,s,r)}},yf:function(a,b){O.Wr(a,350-C.jn.Z(a.length*12,2),b)},b6:function(){$.VG=new O.B9(0,0,700,340)
$.Ho=new O.mG(10,278,0,0,!1,!1)
$.Ed=0
$.Ed=0},hz:function(a){var z,y
z=J.RE(a)
z.e6(a)
if(z.gpL(a)===2)return
z=new P.hL(a.clientX,a.clientY)
H.VM(z,[null])
y=new P.hL(a.clientX,a.clientY)
H.VM(y,[null])
if(O.pA(z.x,y.y,600,380,60,15))O.b6()
else{$.mN=!0
$.NM=1}},mD:function(a){var z,y
z=J.RE(a)
z.e6(a)
if(z.gpL(a)===2)return
z=new P.hL(a.clientX,a.clientY)
...
y=new P.hL(a.clientX,a.clientY)
H.VM(y,[null])
if(O.pA(z.x,y.y,600,380,60,15))return
$.mN=!1
z=$.Ho
if(z.oJ)return
z.aK=$.Ed/116*50
$.pa().toString
z.v3=-(10-Math.random()*3)
if($.Ed>=114)$.iJ=!0
else $.iJ=!1
$.Ed=0
$.Ho.oJ=!0},pA:function(a,b,c,d,e,f){var z
if(typeof a!=="number")throw a.F()
if(a>=c){if(typeof b!=="number")throw b.F()
z=b>=d&&a<=c+e&&b<=b+f}else z=!1
if(z)return!0
return!1},mG:{"":"a;x,y,aK,v3,oJ,nv",
Zf:function(){this.x=this.x+this.aK
this.y=this.y+this.v3
this.aK=this.aK*0.993
this.v3=this.v3*0.99
if(this.y+20>=301){if(this.v3<=1)this.v3=0
if(this.aK<=0.8)this.aK=0
this.y=280
this.v3=-this.v3
this.v3=this.v3*0.9}else this.v3=this.v3+0.1
$.Wv=C.CD.yu(this.x)-$.YT
if(this.aK===0&&this.v3===0)if(this.oJ){this.Vk()
this.nv=!0
this.oJ=!1}},
T1:function(){var z,y,x,w
z=$.Ee
y=$.Jj
x=new P.tn(C.CD.yu(this.x)-$.VG.x,C.CD.yu(this.y),22,20)
H.VM(x,[null])
w=new P.tn(0,0,22,20)
H.VM(w,[null])
J.I8(z,y,x,w)},
Vk:function(){$.UI=$.UI+C.CD.yu(C.jn.Z($.Wv,20)*1.1)}},B9:{"":"a;x,y,ES,bK"}},1],])
...
init.globalFunctions.eE=O.eE=new H.yh(O.Iq,"eE")
init.globalFunctions.nT=O.nT=new P.vE(O.tV,"nT")
init.globalFunctions.Km=O.Km=new P.vE(O.hz,"Km")
init.globalFunctions.yM=O.yM=new P.vE(O.mD,"yM")
J.im.$isint=true
J.im.$isa=true
J.P.$isa=true
J.O.$isString=true
